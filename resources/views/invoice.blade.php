                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="clearfix">
                                    <div class="pull-left">
                                        <h4 class="text-right">Inventory Manager</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="pull-right m-t-30">
                                            ...
                                            <p><strong>Invoice Created By: </strong> {{ Auth::user()->name }}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="hidden-print">
                                    <div class="pull-right">
                                        <a href="#" class="btn btn-lg btn-success waves-effect waves-light"
            ...
            <div class="modal-dialog">
                <div class="modal-content bg-success">
                    <div class="modal-header ">
                        ...
                        <h4 class="modal-title text-white">Invoice of {{ $customer->name }}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="field-4" class="control-label">Select Payment Method</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="field-5" class="control-label">Paying Amount</label>
                                    <input type="text" class="form-control" id="field-5" name="pay">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="field-6" class="control-label">Due Amount</label>
                    ...
                    <input type="hidden" name="invoice_creator" value="{{ Auth::user()->name }}">
