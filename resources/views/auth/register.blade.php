			...
			<div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input class="input100 {{ $errors->has('name') ? ' is-invalid' : '' }}"  type="text" name="name" value="{{ old('name') }}" required placeholder="Enter username">
					...
					<div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						...
						<input class="input100 {{ $errors->has('password') ? ' is-invalid' : '' }}" type="password" name="password" required placeholder="Enter password">
                        <span class="focus-input100"></span>
                    ...
                    <div class="wrap-input100 validate-input m-b-18" data-validate = "Password is required">
						...
						<input class="input100 {{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}" type="password" name="password_confirmation" required placeholder="Confirm password">
                        <span class="focus-input100"></span>
					...
					<div class="flex-sb-m w-full p-b-30">
                        ...
                        <div>
                            <a href="{{URL::to('login')}}"  class="txt1">Already have an Account?</a>
                        </div>
					</div>
